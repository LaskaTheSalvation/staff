...
// Daftar semua section yang bisa ditambahkan di halaman "Media"
const allAvailableSections = [
  "BANNER CONTENT",
  "GALLERY",
];

const DaftarHalamanMediaCard = ({
  title = "Daftar Halaman",
  desc = "Kelola urutan dan section menu Media di bawah ini.",
}) => {
  ...
  const handleCodeButtonClick = (sectionName) => {
    ...
    // navigate(`/staff/media#${urlFriendlyName}`);
  };
...
export default DaftarHalamanMediaCard;
