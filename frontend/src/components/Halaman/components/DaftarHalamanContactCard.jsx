...
// Daftar semua section yang bisa ditambahkan di halaman "Contact"
...
const DaftarHalamanContactCard = ({
  title = "Daftar Halaman",
  desc = "Kelola urutan dan section menu Contact di bawah ini.",
}) => {
  ...
  const handleCodeButtonClick = (sectionName) => {
    ...
    // Bisa tambahkan logic navigasi jika perlu
  };
...
export default DaftarHalamanContactCard;
