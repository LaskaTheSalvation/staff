...
// import { useNavigate } from 'react-router-dom'; // Aktifkan jika perlu navigasi

// Daftar semua section yang bisa ditambahkan di halaman "Service"
...
const DaftarHalamanServiceCard = ({
  title = "Daftar Halaman",
  desc = "Kelola urutan dan section menu Service di bawah ini.",
}) => {
  ...
  const handleCodeButtonClick = (sectionName) => {
    ...
    // navigate(`/staff/service#${urlFriendlyName}`);
  };
...
export default DaftarHalamanServiceCard;
