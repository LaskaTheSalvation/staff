...
import DaftarHalamanServiceCard from "./components/DaftarHalamanServiceCard";

const SectionServiceHalaman = () => {
  ...
  return (
    <section className="mb-10">
      ...
      {isExpanded && (
        <DaftarHalamanServiceCard />
      )}
    </section>
  );
};

export default SectionServiceHalaman;
