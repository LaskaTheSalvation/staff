...
const JourneyDescriptionCard = ({ id, onRemove }) => (
  <div className="relative mb-4">
    ...
    <div className="ml-2 bg-white dark:bg-[var(--color-card-bg)] rounded-lg shadow-elevated px-6 pt-5 pb-6">
      ...
      <p className="text-[13px] mb-4 text-[var(--color-button-blue)]">Tulis deskripsi Our Journey di bawah ini.</p>
      <textarea
        placeholder="Masukkan deskripsi Our Journey di sini..."
