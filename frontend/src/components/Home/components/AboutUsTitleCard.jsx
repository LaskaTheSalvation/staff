...
const AboutUsTitleCard = ({ id, onRemove }) => (
  <div className="relative mb-4">
    ...
    <div className="ml-2 bg-white dark:bg-[var(--color-card-bg)] rounded-lg shadow-elevated px-6 pt-5 pb-6">
      ...
      <p className="text-[13px] mb-4 text-[var(--color-button-blue)]">Masukkan judul About Us di bawah ini.</p>
      <input
        type="text"
        placeholder="Masukkan judul..."
        className="w-full px-4 py-2 bg-gray-100 dark:bg-[var(--color-card-secondary)] border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none text-[var(--color-button-blue)] mb-4"
      />
...
export default AboutUsTitleCard;
