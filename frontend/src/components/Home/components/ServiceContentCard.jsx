...
const ServiceContentCard = ({ id, onRemove }) => {
  return (
    <div className="relative mb-4">
      ...
      <div className="ml-2 bg-white dark:bg-[var(--color-card-bg)] rounded-lg shadow-elevated px-6 pt-5 pb-6 border border-transparent">
        {/* Judul & deskripsi */}
        <h3 className="text-lg font-bold mb-0.5 text-[var(--color-button-blue)]">Content</h3>
        <p className="text-[13px] mb-4 text-[var(--color-button-blue)]">
          Masukkan detail layanan di bawah ini.
        </p>

        {/* Input untuk nama, title, text */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          <input
            type="text"
            placeholder="Nama"
            className="w-full px-4 py-2 bg-gray-100 dark:bg-[var(--color-card-secondary)] border border-gray-300 dark:border-gray-600 text-black dark:text-black rounded-xl focus:outline-none"
          />
          <input
            type="text"
            placeholder="Title"
