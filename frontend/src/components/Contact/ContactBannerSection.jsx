...
import ContactBannerDescriptionCard from "./components/ContactBannerDescriptionCard";
import ContactMapCard from "./components/ContactMapCard";

const componentMap = {
  Title: ContactTitleCard,
  Description: ContactBannerDescriptionCard,
  Map: ContactMapCard,
};

const dropdownOptions = ["Title", "Description", "Map"];

const ContactBannerSection = () => {
  const [contents, setContents] = useState(() => {
    const saved = localStorage.getItem("contact_banner_contents");
  ...
  useEffect(() => {
    localStorage.setItem("contact_banner_contents", JSON.stringify(contents));
  }, [contents]);
