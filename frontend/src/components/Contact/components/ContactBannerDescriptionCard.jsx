...
const ContactBannerDescriptionCard = ({ id, onRemove }) => {
  ...
  const handleCancel = () => {
    ...
    // Jangan keluar dari mode edit jika data original kosong
    ...
    <div className="relative mb-4">
      ...
      <div className="ml-2 bg-white dark:bg-[var(--color-card-bg)] rounded-lg shadow-elevated px-6 pt-5 pb-6">
        ...
        <p className="text-[13px] mb-4 text-[var(--color-button-blue)]">
          Kelola deskripsi untuk halaman kontak Anda.
        </p>
                ...
                <>
                  <td className="p-2">
                    <input 
                      ...
                      placeholder="Contoh: Deskripsi Kontak"
                    />
                  </td>
                  <td className="p-2">
                    <textarea
                      ...
                      className="w-full px-2 py-1 rounded border border-gray-300 dark:border-gray-600 bg-transparent text-[var(--color-button-blue)] resize-y"
                      placeholder="Contoh: Silakan isi form di bawah ini untuk menghubungi kami."
                    />
                  </td>
                </>
              ) : (
...
export default ContactBannerDescriptionCard;
